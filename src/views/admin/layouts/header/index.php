                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item d-flex gap-2 align-items-center">
                            <a class=" text-white nav-link active fs-5" href="/admin"><i
                                    class="fa-solid fa-house"></i></a>
                            <a class=" text-white nav-link active fs-5" href="/admin/add"><i
                                    class="fa-solid fa-plus"></i> Sản phẩm</a>
                            <a class="text-white nav-link active fs-5" href="/admin/order">Đơn hàng<i
