        ...
        <div class="container">
            <div class="row shadow-lg">
                <div class="d-flex justify-content-between p-3 bg-dark">
                    <a href="#" class="text-decoration-none fw-bold text-white" style="font-size: 17px;">
                        Sản phẩm mới
                    </a>
                    <a href="#" class="text-decoration-none fw-bold text-white d-flex align-items-center" style="font-size: 14px;">
                        Xem tất cả
                    </a>
                </div>
            </div>
